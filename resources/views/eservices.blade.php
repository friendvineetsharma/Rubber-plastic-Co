...
@section('body')
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          <li class="drop-down"><a href="/product">Products</a>
            <ul>
              <li><a href="/erubber_sheets">Rubber Sheets</a></li>
              <li><a href="#">Drop Down 2</a></li>
              <li><a href="#">Drop Down 3</a></li>
              <li><a href="#">Drop Down 4</a></li>
            </ul>
          </li>
          <li class="active"><a href="/eservices">Services</a></li>
  ...
  <a href="/add_s"><button type="button" class="btn btn-outline-success btn-lg btn-block">Add Service</button></a>
  <div class="my-5"></div>
  </main>
